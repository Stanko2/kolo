...
INSERT INTO "new_Organization" ("ICO", "active", "address", "description", "email", "emailToken", "id", "name", "userId") SELECT "ICO", "active", "address", "description", "email", "emailToken", "id", "name", "userId" FROM "Organization";
